...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference('Shipment.count') do
      post shipments_url, params: { shipment: { value: @shipment.value, weight_kg: @shipment.weight_kg } }
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { value: @shipment.value, weight_kg: @shipment.weight_kg } }
